...
Lors des années 1950, les pays avaient des PIB par habitant beacoup plus similaire et plus bas. Toutefois, les courbes des continents non Africain, particulièrement l'Europe, se sont grandement applati et allongi, indiquant d'une part une hausse moyenne des émissions de CO2 par habitant et d'autre part, davantage d'inégalité entre les pays des continents quant aux émissions par capita. Finalement, on constate que malgré 60 ans de différence entre 2015 et 1955, les émissions africaines sont relativement stable, parcilièrement en contraste au aux autres continent comme l'Europe.

## Si vous voulez télécharger les données

<<<<<<< HEAD
Télécharger ici : \[Our World in Data - Données CO2\](https://github.com/owid/co2-data)
=======
> Les données proviennent entre autres de @owiCO2
>>>>>>> cc27a350c431c92977ac7b9fc54cf8930b85d0e6
