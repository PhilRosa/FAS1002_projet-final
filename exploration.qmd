...
tableau1 <- dat %>% get_summary_stats(population,gdp,co2,co2_per_capita,co2_per_gdp,energy_per_capita,energy_per_gdp,
                          show=c("min","max", "mean", "sd","median"))
suppressWarnings(print(tableau1))
```
...
suppressWarnings((print(graphique_co2_pib + geom_smooth(se = FALSE, method = lm)))) 
```
...
suppressWarnings(printgraph_evol_co2)
suppressWarnings(printgraph_evol_pop)
suppressWarnings(printgraph_evol_co2c)
...
suppressWarnings(print(graph_1955 + graph_1975 ) +
    plot_annotation(title = "Distribution du PIB par habitant à chaque 20 ans depuis 1955"))

suppressWarnings(print(graph_1995 + graph_2015))
```
